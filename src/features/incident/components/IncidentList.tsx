...
export function IncidentList() {
	...
	const [incidents, setIncidents] = useState<Incident[]>(() => {
		try {
			...
			localStorage.setItem('elevator_incidents_db', JSON.stringify(INITIAL_INCIDENTS))
	...
	const handleUpdateStatus = (id: string, status: IncidentStatus) => {
		const updated = incidents.map((inc) => (inc.id === id ? { ...inc, status, updatedAt: getCurrentTimestamp() } : inc))
		saveIncidents(updated)
	}
